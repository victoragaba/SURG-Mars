...
def compute_mech(event_x,num_events,event_id,event_pol_df,p_dict,lookup_dict,qual_criteria_dict,cat_df,dir_cos_dict):
	...
	p_pol=event_pol_df['p_polarity'].values.copy()
	...
	if p_dict['outfolder_plots']:
		...
		# # create a csv and store all takeoff and azimuth
		# if p_dict['outfile_pol_info']:
		# 	pol_info_df=event_pol_df.copy()
		# 	pol_info_df['takeoff']=out_takeoff
		# 	pol_info_df['sr_az']=out_sr_az
		# 	out.write_pol_info(p_dict['outfile_pol_info'],pol_info_df,event_id)

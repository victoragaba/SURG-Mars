...
# difference in the transcribed vs what I implemented
# what does the quaternion encode? parameter count
# Aki & Richards
# do I get the same answers?
# "average" beachball by some metric - MT
# kagan angle relative to average beaachball

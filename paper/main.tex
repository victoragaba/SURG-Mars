...
\section{Cosine similarity misfit criterion} \label{sec:misfit}
  ...
  \subsection{Tolerance derivation}
    ...
    \begin{align} \label{eq:12}
      ...
      \Rightarrow c_1 = \bm{A}_o^\top \tilde{\bm{\Sigma}}^{-1} \bm{A}_o = \|\bm{A}_o^\top, \bm{A}_o\|_{\tilde{\bm{\Sigma}}^{-1}}^2
    \end{align}
    ...
    Denote $c_3 = \bm{A}_s^\top \tilde{\bm{\Sigma}}^{-1} \bm{A}_s = \|\bm{A}_s^\top, \bm{A}_s\|_{\tilde{\bm{\Sigma}}^{-1}}^2$. Then by
